// This is minor Mod From github.com/RandDruid/esp8266-deauth
// NOTE, REQUIRED SDK1.3 - Please select ESP version 2.0.0-rc in your Arduino board manager
// No code change required to user_interface.h
...
void print_client(clientinfo ci)
{
  ...
  if (ci.err != 0) {
    ...
    /*  This part cause restart! serial buffer overflow?
